...
ONBOARDING = {
    LANGUAGE_RU: {
        ...
        "generating_next_question": "⏳ Генерирую следующий вопрос... подождите.",
    },
    LANGUAGE_EN: {
        "welcome": None,  # Generated by LLM in game_server.py
        ...
        "generating_next_question": "⏳ Generating the next question... please wait.",
    },
}
...
IMAGES = {
    LANGUAGE_RU: {
        ...
        "sg_intro_caption": "🧬 Теперь ответьте на 5 вопросов, которые помогут определить ваш пол и расу. Генерация каждого вопроса занимает от 30 до 60 секунд.",
        "processing_caption": "✨ Ваши ответы обрабатываются. Личное дело шифруется звёздной пылью",
    },
    LANGUAGE_EN: {
        ...
        "sg_intro_caption": "🧬 Now answer 5 questions that will help determine your species and gender. Generating each question takes 30 to 60 seconds.",
