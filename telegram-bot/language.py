...
PLAYER_LANG = {
    LANGUAGE_RU: {
        "language_set": "✅ Язык изменён на {language} {flag}",
        "player_language": "🌐 Язык игрока: {language} {flag}",
        "game_language": "🎮 Язык игры: {language} {flag}",
    },
    LANGUAGE_EN: {
        "language_set": "✅ Language changed to {language} {flag}",
        "player_language": "🌐 Player language: {language} {flag}",
        "game_language": "🎮 Game language: {language} {flag}",
    },
}
...
ONBOARDING = {
    LANGUAGE_RU: {
        ...
        "character_card_forced": (
            "🧬 *Персонаж закреплён за вами* (3 отказа исчерпаны)\n\n"
            "*Роль:* {role}\n"
            "*Вид:* {species}\n"
            "*Пол:* {gender}\n\n"
            "{role_description}\n\n"
        ...
        "character_accept_button": "✅ Да, беру!",
        "character_reroll_button": "🎲 Другой персонаж",
        "character_rerolling": "🎲 Кидаю кости заново — генерирую другого персонажа...",
        "game_already_started": "🚀 Игра уже началась, добро пожаловать на борт!",
        "game_already_started_mission": "🚀 *Миссия:* {mission_name}",
        "game_already_started_info": "{mission_description}\n\n*Цели миссии:*\n{mission_objectives}\n\n📡 *Текущий ход:* {turn}\n⏭ *Следующий ход будет сделан:* {schedule_time}",
        ...
        "deeplink_conflict": "📨 Вас пригласили в новую игру *«{new_game}»*, но у вас уже есть персонаж в игре *«{current_game}»*.\n\nЧто выберете?",
        "deeplink_join_button": "🎮 Присоединиться к «{new_game}»",
        "deeplink_back_button": "🔙 Остаться в «{current_game}»",
        "deeplink_back_done": "👌 Вы остаётесь в текущей игре. Используйте /turn для хода и /profile для профиля.",
        ...
        "invite_qr_caption": "📱 Наведи камеру на QR-код, чтобы присоединиться!\n\n{forward}",
        "invite_no_game_caption": "🎮 Приглашаю тебя в космическое приключение! Создавай персонажа и отправляйся в миссию вместе с друзьями.\n\n{invite_url}",
        "invite_no_game_forward": "👆 Перешли это сообщение другу!\n\nИли отправь ему ссылку:\n{invite_url}",
        ...
        "schedule_set_confirm": "✅ *Расписание установлено:* {label}\n\nХода начнут генерироваться по расписанию, как только соберётся команда (минимум 3 игрока).\n\nА теперь знакомьтесь — ваш персонаж!",
        ...
        "schedule_custom_prompt": "✏️ *Введите своё расписание*\n\nНапишите одним сообщением, как часто ходы будут генерироваться. Доступные форматы:\n\n• Интервал: `6h` (каждые 6 часов), `30m` (каждые 30 минут)\n• Время по UTC: `08:00` (каждый день в 08:00)\n• Несколько раз в день: `08:00,12:00,14:00`\n• Диапазон: `06:00-18:00/1h` (каждый час с 06:00 до 18:00 включительно, время UTC)\n• По дням недели: `mon-08:00,wed-12:00`\n  (mon/tue/wed/thu/fri/sat/sun)\n\nНапример, чтобы ходы каждые 8 часов — напишите `8h`.",
        "schedule_invalid_format": "❌ Не понимаю формат «{value}». Используйте, например: 6h, 12h, 08:00, 08:00,20:00, 06:00-18:00/1h или mon-08:00. Попробуйте ещё раз:",
        "game_generating": "🚀 *Создаю игру...*\n\n⏳ Идёт первичная генерация игры (миссия, название, корабль). Это займёт около минуты. Пожалуйста, подождите.",
        "already_onboarding": "🎨 Ваш персонаж генерируется, карточка придёт через минуту. Пожалуйста, подождите.",
    },
    LANGUAGE_EN: {
        "welcome": None,  # Generated by LLM in game_server.py
        ...
        "character_card_forced": (
            "🧬 *This character is now yours* (3 rejections used up)\n\n"
            "*Role:* {role}\n"
            "*Species:* {species}\n"
            "*Gender:* {gender}\n\n"
            "{role_description}\n\n"
        ...
        "character_accept_button": "✅ Yes, mine!",
        "character_reroll_button": "🎲 Another one",
        "character_rerolling": "🎲 Rolling the dice again — generating another character...",
        ...
        "game_already_started_mission": "🚀 *Mission:* {mission_name}",
        "game_already_started_info": "{mission_description}\n\n*Mission Objectives:*\n{mission_objectives}\n\n📡 *Current Turn:* {turn}\n⏭ *Next turn scheduled:* {schedule_time}",
        ...
        "deeplink_conflict": "📨 You've been invited to a new game *«{new_game}»*, but you already have a character in *«{current_game}»*.\n\nWhat do you choose?",
        "deeplink_join_button": "🎮 Join «{new_game}»",
        "deeplink_back_button": "🔙 Stay in «{current_game}»",
        "deeplink_back_done": "👌 You're staying in your current game. Use /turn for the turn and /profile for your profile.",
        ...
        "invite_qr_caption": "📱 Point your camera at the QR code to join!\n\n{forward}",
        "invite_no_game_caption": "🎮 Join a sci-fi adventure! Create your character and embark on a mission with friends.\n\n{invite_url}",
        "invite_no_game_forward": "👆 Forward this message to a friend!\n\nOr send them this link:\n{invite_url}",
        ...
        "schedule_set_confirm": "✅ *Schedule set:* {label}\n\nTurns will generate on schedule once the crew assembles (at least 3 players).\n\nNow meet your character!",
        ...
        "schedule_custom_prompt": "✏️ *Enter your own schedule*\n\nSend one message describing how often turns generate. Supported formats:\n\n• Interval: `6h` (every 6 hours), `30m` (every 30 minutes)\n• Time of day (UTC): `08:00` (daily at 08:00)\n• Multiple times a day: `08:00,12:00,14:00`\n• Range: `06:00-18:00/1h` (hourly from 06:00 to 18:00 inclusive, UTC)\n• Weekday-specific: `mon-08:00,wed-12:00`\n  (mon/tue/wed/thu/fri/sat/sun)\n\nFor example, for turns every 8 hours, send `8h`.",
        "schedule_invalid_format": "❌ I don't understand the format «{value}». Use e.g. 6h, 12h, 08:00, 08:00,20:00, 06:00-18:00/1h or mon-08:00. Try again:",
        "game_generating": "🚀 *Creating the game...*\n\n⏳ Primary game generation in progress (mission, title, ship). This will take about a minute. Please wait.",
        "already_onboarding": "🎨 Your character is being generated, the card will arrive in a minute. Please wait.",
    },
}
...
IMAGES = {
    LANGUAGE_RU: {
        ...
        "onboarding_wait": "🎲 Генерирую случайного персонажа: роль, раса, характер и портрет. Это займёт около минуты. Пожалуйста, подождите.",
        "processing_caption": "✨ Персонаж принят. Личное дело шифруется звёздной пылью",
    },
    LANGUAGE_EN: {
        "loading_caption": "🚀 System initializing... Starship computer booting up.",
        "onboarding_wait": "🎲 Rolling a random character: role, species, personality and a portrait. This will take about a minute. Please wait.",
        "processing_caption": "✨ Character accepted. Stellar cartography mapping your destiny",
    },
}
...
GM_COMMANDS = {
    LANGUAGE_RU: {
        ...
        "set_language_in_progress": "⏳ Смена языка для игры `{game_id}` уже идёт — дождитесь уведомления о завершении.",
        ...
        "schedule_usage": "❌ Использование: /gm_schedule <game_id> <формат>\n\nФорматы: 6h (каждые N часов), 30m (каждые N минут), 08:00 (ежедневно в HH:MM), 08:00,12:00 (несколько раз в день), 06:00-18:00/1h (каждый час с 06:00 до 18:00 включительно, время UTC), mon-08:00,wed-12:00 (по дням недели)\n\nПример: /gm_schedule abc123 6h",
    ...
    LANGUAGE_EN: {
        ...
        "set_language_in_progress": "⏳ Language change for game `{game_id}` is already in progress — wait for the completion notification.",
        ...
        "schedule_usage": "❌ Usage: /gm_schedule <game_id> <format>\n\nFormats: 6h (every N hours), 30m (every N minutes), 08:00 (daily at HH:MM), 08:00,12:00 (multiple times/day), 06:00-18:00/1h (hourly from 06:00 to 18:00 inclusive, UTC), mon-08:00,wed-12:00 (weekly by day)\n\nExample: /gm_schedule abc123 6h",
...
PUSH_OUTCOME = {
    LANGUAGE_RU: {
        ...
        "mission_progress_item": "  {direction}{points} — Этап {stage}: {name} ({progress}/{threshold})",
        "mission_stage_recap_done": "  ✓ Этап {stage}: {name} ({progress}/{threshold})",
        "mission_stage_recap_active": "  • Этап {stage}: {name} ({progress}/{threshold})",
    ...
    LANGUAGE_EN: {
        ...
        "mission_progress_item": "  {direction}{points} — Stage {stage}: {name} ({progress}/{threshold})",
        "mission_stage_recap_done": "  ✓ Stage {stage}: {name} ({progress}/{threshold})",
        "mission_stage_recap_active": "  • Stage {stage}: {name} ({progress}/{threshold})",
