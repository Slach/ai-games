...
GM_COMMANDS = {
    LANGUAGE_RU: {
        ...
        "games_list_entry": "{idx}. `{game_id}` — {title} ({player_count} игр., {onboarding_count} онб., {status_icon} {status})",
    ...
    LANGUAGE_EN: {
        ...
        "games_list_entry": "{idx}. `{game_id}` — {title} ({player_count} pl., {onboarding_count} onb., {status_icon} {status})",
...
PUSH_OUTCOME = {
    LANGUAGE_RU: {
        ...
        "character_caption": "🎯 Ход {day} — {role}",
    ...
    LANGUAGE_EN: {
        ...
        "character_caption": "🎯 Turn {day} — {role}",
