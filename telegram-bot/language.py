...
ONBOARDING = {
    LANGUAGE_RU: {
        ...
        "schedule_invalid_format": "❌ Не понимаю формат «{value}». Используйте, например: 6h, 12h, 08:00, 08:00,20:00 или mon-08:00. Попробуйте ещё раз:",
    ...
    LANGUAGE_EN: {
        ...
        "schedule_invalid_format": "❌ I don't understand the format «{value}». Use e.g. 6h, 12h, 08:00, 08:00,20:00 or mon-08:00. Try again:",
...
GM_COMMANDS = {
    LANGUAGE_RU: {
        ...
        "schedule_usage": "❌ Использование: /gm_schedule <game_id> <формат>\n\nФорматы: 6h (каждые N часов), 30m (каждые N минут), 08:00 (ежедневно в HH:MM), 08:00,12:00 (несколько раз в день), mon-08:00,wed-12:00 (по дням недели)\n\nПример: /gm_schedule abc123 6h",
    ...
    LANGUAGE_EN: {
        ...
        "schedule_usage": "❌ Usage: /gm_schedule <game_id> <format>\n\nFormats: 6h (every N hours), 30m (every N minutes), 08:00 (daily at HH:MM), 08:00,12:00 (multiple times/day), mon-08:00,wed-12:00 (weekly by day)\n\nExample: /gm_schedule abc123 6h",
