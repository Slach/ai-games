...
def _make_npc_briefing(turn, npc_key, game_id, *, selected="action_1"):
    ...
    return {
        ...
        "choices": [
            {"id": "action_1", "text": "Взломать протокол фильтрации ИИ", "consequence": "Системы мостика гаснут.", "consequence_kind": "progress"},
            {"id": "action_2", "text": "Синхронизировать сенсоры с вибрациями корпуса", "consequence": "Успешная синхронизация.", "consequence_kind": "progress"},
        ],
        "selected_action_id": selected,
        "choice_rationale": "Мой разум требует чистоты данных.",
        "consequence_result": {"consequence": "Системы мостика гаснут.", "consequence_kind": "progress"},
